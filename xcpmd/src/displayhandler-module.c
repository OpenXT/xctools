...
//Actions
void screen_on(struct arg_node * args) {
    com_openxt_vglass_set_dpms_(xcdbus_conn, "com.openxt.vglass", "/com/openxt/vglass", false);
}


void screen_off(struct arg_node * args) {
    com_openxt_vglass_set_dpms_(xcdbus_conn, "com.openxt.vglass", "/com/openxt/vglass", true);
}
